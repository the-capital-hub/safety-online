...
const InvoiceDocument = ({ order }) => {
	...
	// }));
        ...
        const billToPhone = deliveryAddress?.phone || order?.customerMobile;
        const billToEmail = deliveryAddress?.email || order?.customerEmail;
        const shipToPhone = deliveryAddress?.phone || order?.customerMobile;
        const shipToEmail = deliveryAddress?.email || order?.customerEmail;
