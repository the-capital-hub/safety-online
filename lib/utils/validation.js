...
const RULES = {
  ...
  name: {
    ...
    title: "Only letters, numbers, spaces, apostrophes, periods, hyphens or slashes.",
  },
  tag: {
    maxLength: 60,
  ...
  phone: {
    ...
    sanitize: (value) => {
      ...
      return sanitized.startsWith("++") ? sanitized.replace(/^\++/, "+") : sanitized;
    },
    inputMode: "tel",
    autoComplete: "tel",
    title: "Enter 7 to 15 digits. You may prefix with +.",
  },
  emailOrPhone: {
    maxLength: 254,
...
const KEYWORD_RULES = [
  ...
  { keywords: ["length", "width", "height", "depth", "dimension"], rule: "dimension" },
