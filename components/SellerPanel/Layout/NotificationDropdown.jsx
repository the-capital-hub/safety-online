...
export function NotificationDropdown() {
	...
	const markPanelAsRead = useNotificationStore(
		(state) => state.markPanelAsRead
	);
	...
	// console.log("sellerNotifications:", sellerNotifications);
											...
											{notification.link?.href && (
												<Button
													...
													onClick={() => {
														...
														router.push("/seller/orders"); // notification.link.href is not working properly here bcz it's "/admin/orders"
													}}
												>
