...
// 	return (
// 		<section className="relative bg-gray-100 overflow-hidden min-h-[calc(100vh-136px)] px-4 sm:px-6 lg:px-10">
// 			<div className="h-full flex flex-col">
// 				{/* Hero Titles - Fixed positioning for mobile */}
// 				<div className="relative w-full pt-8 pb-4 lg:pt-16 lg:pb-8">
// 					<motion.h1
// 						initial={{ opacity: 0, y: 30 }}
// 						animate={{ opacity: 1, y: 0 }}
// 						transition={{ duration: 0.8 }}
// 						className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-8xl font-black leading-tight text-center lg:text-left lg:absolute lg:top-0 lg:left-0"
// 					>
// 						SAFETY GEAR,
// 					</motion.h1>
// 					<motion.h1
...
// 						className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl xl:text-8xl font-black leading-tight text-center lg:text-right lg:absolute lg:top-16 lg:right-0 z-10 mt-2 lg:mt-0"
// 					>
// 						SERIO
// 						<span className="text-black/50 stroke-white">US</span>{" "}
// 						<span className="text-black/50 stroke-white">P</span>
...
// 				{/* Main Content Grid */}
// 				<div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center lg:items-start lg:pt-24">
// 					{/* Categories Sidebar */}
// 					<motion.div
...
// 					>
// 						<div className="flex flex-row lg:flex-col space-x-4 lg:space-x-0 lg:space-y-4 overflow-x-auto lg:overflow-x-visible pb-2 lg:pb-0">
// 							{sidebarCategories.map((category, index) => (
// 								<motion.div
// 									key={category}
// 									initial={{ opacity: 0, x: -20 }}
...
// 								>
// 									<p
// 										className={`text-sm sm:text-base lg:text-xl xl:text-2xl font-bold whitespace-nowrap lg:whitespace-normal ${
// 											index === 0 ? "text-black" : "text-gray-300"
// 										}`}
// 									>
// 										{category}
...
// 						animate={{ opacity: 1, y: 0 }}
// 						transition={{ delay: 0.3, duration: 0.8 }}
// 						className="lg:col-span-4 order-2 lg:order-3 text-center lg:text-left"
// 					>
// 						<p className="text-gray-600 mb-6 text-sm sm:text-base lg:text-lg max-w-md mx-auto lg:mx-0">
// 							Safety is the most basic yet the most important rule of life. It
// 							is the sum of safety precautions that determines the safety of the
// 							people working near you.
// 						</p>
// 						<Button className="bg-black text-white px-6 md:px-8 py-3 md:py-4 rounded-full text-sm md:text-base font-medium hover:bg-gray-800 transition-colors">
// 							BUY NOW
// 							<ArrowRight className="ml-2 h-4 w-4" />
// 						</Button>
// 					</motion.div>
...
// 				animate={{ opacity: 1 }}
// 				transition={{ delay: 1 }}
// 				className="absolute bottom-4 lg:bottom-6 left-1/2 transform -translate-x-1/2 animate-bounce"
// 			>
// 				<Button
// 					variant="outline"
// 					size="icon"
