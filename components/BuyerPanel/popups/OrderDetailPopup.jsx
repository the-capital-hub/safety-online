...
export function OrderDetailPopup({ open, onOpenChange, order }) {
    ...
    const customerMobile = order.customerMobile || order.customer?.mobile || order.customer?.phone || 'N/A';
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="space-y-2">
                                        ...
                                        <p>
                                            {order.shippingAddress.zipCode || order.shippingAddress.postalCode || 'N/A'},{" "}
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        {products.map((product, index) => (
                                            ...
                                            >
                                                <Image
                                                    src={product?.productImage || product?.image || "https://res.cloudinary.com/drjt9guif/image/upload/v1755168534/safetyonline_fks0th.png"}
                                                ...
                                                <div className="flex-1">
                                                    <h4 className="font-medium">{product.productName || product.name || 'N/A'}</h4>
                                                ...
                                                <div className="text-right">
                                                    <p className="font-medium">
                                                        ₹{(product.totalPrice || (product.price * product.quantity) || 0).toFixed(2)}
                                                    </p>
                                                </div>
                                            </div>
                                        ))}
