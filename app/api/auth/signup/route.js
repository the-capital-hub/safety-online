...
export async function POST(req) {
    ...
    `;
                ...
                if (companyInfo.adminEmail) {
                        const adminHtml = `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:20px;color:#111827;background:#f9fafb;">
          <h2 style="color:#111827;">New customer registration</h2>
          <p style="margin:0 0 16px 0;">A new user has just created an account on ${
                                        companyInfo.name
                                }.</p>
          ${tableHtml}
          <p style="margin-top:16px;font-size:12px;color:#6b7280;">This is an automated notification sent to administrators.</p>
        </div>
      `;
