...
export async function GET(req, { params }) {
	...
	try {
		...
		const transformedProduct = {
			...
			image: product.images?.[0] || "https://res.cloudinary.com/drjt9guif/image/upload/v1755168534/safetyonline_fks0th.png",
		...
		const transformedRelatedProducts = relatedProducts.map((p) => ({
			...
			image: p.images?.[0] || "https://res.cloudinary.com/drjt9guif/image/upload/v1755168534/safetyonline_fks0th.png",
			inStock: p.stocks > 0,
